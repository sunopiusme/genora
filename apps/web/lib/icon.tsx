...
const SOLAR_ICONS: Record<string, string> = {
  ...
  /* ── Иконки композера (chat input) ──────
     ...
     api.iconify.design/solar) — та же семья, что
     и sidebar. Зарегистрированы здесь же, чтобы
     весь ввод (тулбар, меню «+», project picker)
     рендерился из одного offline-реестра:
     мгновенно при SSR и без мерцания. */
  "microphone-2-linear":
    '<g fill="none" stroke="currentColor" stroke-width="1.5"><path d="M7 8a5 5 0 0 1 10 0v3a5 5 0 0 1-10 0z"/><path stroke-linecap="round" d="M13.5 8H17m-3.5 3H17M7 8h2m-2 3h2m11-1v1a8 8 0 1 1-16 0v-1m8 9v3"/></g>',
  ...
  "layers-minimalistic-linear":
    '<g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"><path d="m4.979 9.685l5.176 2.328c.907.408 1.36.612 1.845.612s.938-.204 1.845-.612l5.176-2.328C20.34 9.093 21 8.796 21 8.5s-.66-.593-1.979-1.185l-5.176-2.328c-.907-.408-1.36-.612-1.845-.612s-.938.204-1.845.612L4.979 7.315C3.66 7.907 3 8.204 3 8.5s.66.593 1.979 1.185Z"/><path stroke-linecap="round" d="m20 12.5l.599.29c.934.45 1.401.676 1.401.987s-.467.536-1.401.987l-6.63 3.198c-.96.463-1.44.695-1.969.695s-1.01-.232-1.969-.695l-6.63-3.198C2.467 14.313 2 14.088 2 13.777s.467-.536 1.401-.987L4 12.5"/></g>',
  "add-square-linear":
    '<g fill="none" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" d="M12 8v8m4-4H8"/><path d="M2 12c0-4.714 0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464C22 4.93 22 7.286 22 12s0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12Z"/></g>',
  "close-square-linear":
    '<g fill="none" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" d="m14.5 9.5l-5 5m0-5l5 5"/><path d="M2 12c0-4.714 0-7.071 1.464-8.536C4.93 2 7.286 2 12 2s7.071 0 8.535 1.464C22 4.93 22 7.286 22 12s0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12Z"/></g>',
  "link-round-angle-linear":
    '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"><path d="M10.046 14c-1.506-1.512-1.37-4.1.303-5.779l4.848-4.866c1.673-1.68 4.25-1.816 5.757-.305s1.37 4.1-.303 5.78l-2.424 2.433"/><path d="M13.954 10c1.506 1.512 1.37 4.1-.303 5.779l-2.424 2.433l-2.424 2.433c-1.673 1.68-4.25 1.816-5.757.305s-1.37-4.1.303-5.78l2.424-2.433"/></g>',

  /* Производные состояния (не входят в Solar):
     построены на геометрии Solar — stroke 1.5/2,
     round caps, та же сетка 24. */
  "stop-bold":
  ...
  "check-single-linear":
    '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m4.5 12.75 4.5 4.5L19.5 6.75"/>',
  "github-mark":
...
export function Icon(props: IconProps) {
  ...
  if (
    ...
    console.warn(
      `[icon] "${props.icon}" не зарегистрирована в lib/icon.tsx — доба��ьте её в SOLAR_ICONS`,
    );
  }
