...
export function ModelPicker({ selection, onChange }: Props) {
  ...
  return (
    <div ref={wrapRef} className={styles.wrap}>
      ...
      >
        {/* Brand-эмблема модели (Claude) — инлайновый SVG, чтобы
            логотип рендерился сразу вместе с разметкой без сетевого
...
/* Логотип Claude (simpleicons.org, CC0) — инлайн вместо
   /public/brands/claude.svg, чтобы не мерцал при загрузке. */
